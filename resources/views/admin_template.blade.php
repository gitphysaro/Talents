...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>CRC</b> SUIVI RH</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Catherine KOUKA</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
 ...
 <!-- page content -->
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018-2019 <a href="https://adminlte.io">CRC</a>.</strong> All rights
    reserved.
  </footer>
