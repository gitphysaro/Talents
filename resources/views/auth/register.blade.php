            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="col-md-6">
                                <!-- <input id="fonction" type="text" class="form-control @error('fonction') is-invalid @enderror" name="fonction" value="{{ old('fonction') }}" required autocomplete="fonction" autofocus> -->
                                 <select id="fonction" name="fonction" class="form-control select2">
                                    <option value="" selected disabled>Select fonction</option>
                        ...
                        <div class="form-group row">
                            <label for="access" class="col-md-4 col-form-label text-md-right">{{ __('Access Level') }}</label>

                            <div class="col-md-6">
                                <input id="access" type="number" class="form-control @error('access') is-invalid @enderror" name="access" value="{{ old('access') }}" required autocomplete="access" autofocus>
